...
content_font = '微软雅黑'
other_content = project_path+'/ppt-model/images/default-model/other_content.png'
other_content_rgb = RGBColor(126, 126, 126)
current_content = project_path+'/ppt-model/images/default-model/current_content.png'
current_content_rgb = RGBColor(192,125,52)
content_number_rgb = RGBColor(255, 255, 255)
text_img_path = project_path+'/ppt-model/images/default-model/text_background.png'
unsort_img_path = project_path+'/ppt-model/images/default-model/unsort_list.png'
...
def gen_ppt_default(out_file_path, md_file_path):
    # 这里修改母版路径、输出文件路径等
    # print(os.path.pardir)
    # project_path = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    file_path = project_path+'/ppt-model/default-model.pptx'  # 模板的目录和文件名
